...
parser.add_argument("--split", default='train', choices=['train', 'test', 'val', 'trainval', 'train2014',
                                                         'train-segmentation', 'val-segmentation', 'val2014',
...
parser.add_argument("--output_coco_json", action='store_true')
# Profile options
parser.add_argument("--use_profile", default=False, action='store_true')
...
# the size of the last instance feature map
...
parser.add_argument("--instance_num", default=20, type=int)
